...
class LLMQuerier:
    ...
    def __init__(self, model_name, use_gpu=False):
        ...
        self.model = AutoModelForCausalLM.from_pretrained(model_name, quantization_config=quantization_config, torch_dtype="auto", low_cpu_mem_usage=True).to(self.device)
    ...
    def __format_prompt(cls, question, documents, options, dataset_name):
        ...
        instruction = 'You are a helpful medical expert, and your task is to answer a multi-choice medical question using \
